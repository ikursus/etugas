...
<div class="card">
  <div class="card-header">Senarai Perkara Laporan</div>
  <div class="card-body">

    @include('layouts.alerts')

    <p>
        <a href="{{ route('pentadbir.perkara.create') }}" class="btn btn-primary">
            Tambah Perkara
        </a>
    </p>
...
$(function() {
    $('#datatables-table').DataTable({
        ...
        searchDelay: 500,
        ajax: {
            url: '{!! route('pentadbir.perkara.datatables') !!}',
            type:'POST',
                'headers': {
