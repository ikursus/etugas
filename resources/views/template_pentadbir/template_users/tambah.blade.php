                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="no_staf" type="text" class="form-control @error('no_staf') is-invalid @enderror" name="no_staf" value="{{ old('no_staf') }}" required autocomplete="no_staf" autofocus>
