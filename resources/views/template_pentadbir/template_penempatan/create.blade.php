        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('pentadbir.penempatan.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="negeri" type="text" class="form-control @error('negeri') is-invalid @enderror" name="negeri" value="{{ old('negeri') }}" required autocomplete="negeri" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bahagian" type="text" class="form-control @error('bahagian') is-invalid @enderror" name="bahagian" value="{{ old('bahagian') }}" required autocomplete="bahagian" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tingkat" type="text" class="form-control @error('tingkat') is-invalid @enderror" name="tingkat" value="{{ old('tingkat') }}" required autocomplete="tingkat" autofocus>
